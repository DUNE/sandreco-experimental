...
std::map<component, std::string> component_to_string = {
    {component::GRAIN, "LArHit"},  {component::STRAW, "Straw"},   {component::DRIFT, "DriftVolume"},
    {component::ECAL, "EMCalSci"}, {component::MAGNET, "Magnet"}, {component::WORLD, "World"},
};
...
std::map<std::string, component> string_to_component = {
    {"LArHit", component::GRAIN},  {"Straw", component::STRAW},   {"DriftVolume", component::DRIFT},
    {"EMCalSci", component::ECAL}, {"Magnet", component::MAGNET}, {"World", component::WORLD},
};
 ...
 */
std::initializer_list<std::string> stt_names = {"horizontalST", "STT", "TrkMod",   "CMod",
