...
namespace sand {
  ...
  root_tgeomanager::root_tgeomanager(const ufw::config& cfg) {
    UFW_WARN("Constructing instance of root_tgeomanager at {}. Current gGeoManager = {}", fmt::ptr(this), fmt::ptr(gGeoManager));
    if (gGeoManager) {
    ...
    UFW_WARN("root_tgeomanager at {} now references m_geomenater {}. Current gGeoManager = {}", fmt::ptr(this), fmt::ptr(m_geomanager), fmt::ptr(gGeoManager));
    if (!m_geomanager) {
  ...
  root_tgeomanager::~root_tgeomanager() {
    UFW_WARN("Destroying instance of root_tgeomanager at {}. Current gGeoManager = {}", fmt::ptr(this), fmt::ptr(gGeoManager));
