...
namespace sand::fake_reco {
  ...
  inline caf::SRTrueParticle SRTrueParticle_from_genie(std::size_t i, const StdHep& std_hep) {
    return {
        .pdg            = std_hep.Pdg_[i],
        .G4ID           = -1, // This will be filled by fake_reco loop
        .interaction_id = -1, // this too
  ...
  // inline caf::SRTrueParticle SRTrueParticle_from_genie_and_edepsim(std::size_t i, const StdHep& std_hep,
  //                                                                  const TG4PrimaryParticle& particle) {
  //   return {
  //       .pdg            = particle.GetPDGCode(),
  //       .G4ID           = -1, // This will be filled by fake_reco loop
  //       .interaction_id = -1, // this too
  ...
  inline caf::SRTrueParticle true_particle_from_edep_trajectory(const EDEPTrajectory& particle) {
    return {
        .pdg            = particle.GetPDGCode(),
        .G4ID           = -1,               // ?
