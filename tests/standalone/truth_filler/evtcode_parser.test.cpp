...
BOOST_AUTO_TEST_CASE(parse_neutrino_pdg) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;proc:Weak[CC],QES");
...
BOOST_AUTO_TEST_CASE(parse_electron_neutrino) {
  auto evt = parse_evt_code("nu:12;tgt:1000060120;proc:Weak[CC],QES");
...
BOOST_AUTO_TEST_CASE(parse_carbon_target) {
  auto evt = parse_evt_code("nu:14;tgt:1000060120;proc:Weak[CC],QES");
  BOOST_TEST(evt.target_pdg == 1000060120);  // Carbon-12
}

BOOST_AUTO_TEST_CASE(parse_hit_nucleon_proton) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;N:2212;proc:Weak[CC],QES");
...
BOOST_AUTO_TEST_CASE(parse_hit_nucleon_neutron) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;N:2112;proc:Weak[CC],QES");
  BOOST_TEST(evt.hit_nucleon_pdg.has_value());
  BOOST_TEST(evt.hit_nucleon_pdg.value() == 2112);
}

BOOST_AUTO_TEST_CASE(no_hit_nucleon_for_coherent) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;proc:Weak[CC],COH");
  BOOST_TEST(!evt.hit_nucleon_pdg.has_value());
}
...
BOOST_AUTO_TEST_CASE(parse_nc_interaction) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;N:2212;proc:Weak[NC],QES");
...
BOOST_AUTO_TEST_CASE(parse_res_mode) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;N:2212;proc:Weak[CC],RES");
  BOOST_TEST(evt.scattering_type == ::caf::kRes);
}

BOOST_AUTO_TEST_CASE(parse_dis_mode) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;N:2112;proc:Weak[CC],DIS");
  BOOST_TEST(evt.scattering_type == ::caf::kDIS);
}

BOOST_AUTO_TEST_CASE(parse_mec_mode) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;proc:Weak[CC],MEC");
...
BOOST_AUTO_TEST_CASE(parse_sea_quark) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;N:2112;q:1(s);proc:Weak[CC],DIS");
...
BOOST_AUTO_TEST_CASE(parse_valence_quark) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;N:2112;q:2(v);proc:Weak[CC],DIS");
  BOOST_TEST(evt.hit_quark_pdg.has_value());
...
BOOST_AUTO_TEST_CASE(parse_down_quark_sea) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;N:2212;q:1(s);proc:Weak[CC],DIS");
  BOOST_TEST(evt.hit_quark_pdg.value() == 1);
  BOOST_TEST(evt.hit_sea_quark == true);
}

BOOST_AUTO_TEST_CASE(parse_strange_quark) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;N:2212;q:3(s);proc:Weak[CC],DIS");
...
BOOST_AUTO_TEST_CASE(charm_inclusive) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;N:2112;proc:Weak[CC],DIS;charm:incl");
  BOOST_TEST(evt.is_charm_event == true);
  BOOST_TEST(!evt.charmed_hadron_pdg.has_value());
}

BOOST_AUTO_TEST_CASE(charm_d_plus) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;N:2112;proc:Weak[CC],DIS;charm:411");
  BOOST_TEST(evt.is_charm_event == true);
  BOOST_TEST(evt.charmed_hadron_pdg.has_value());
...
BOOST_AUTO_TEST_CASE(charm_d_zero) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;N:2112;proc:Weak[CC],DIS;charm:421");
  BOOST_TEST(evt.charmed_hadron_pdg.value() == 421);
}

BOOST_AUTO_TEST_CASE(charm_lambda_c) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;N:2112;proc:Weak[CC],DIS;charm:4122");
...
BOOST_AUTO_TEST_CASE(strange_inclusive) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;N:2112;proc:Weak[CC],DIS;strange:incl");
  BOOST_TEST(evt.is_strange_event == true);
  BOOST_TEST(!evt.strange_hadron_pdg.has_value());
}

BOOST_AUTO_TEST_CASE(strange_k_plus) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;N:2112;proc:Weak[CC],1Kaon;strange:321");
  BOOST_TEST(evt.is_strange_event == true);
  BOOST_TEST(evt.strange_hadron_pdg.value() == 321);
}

BOOST_AUTO_TEST_CASE(strange_lambda) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;N:2112;proc:Weak[CC],DIS;strange:3122");
...
BOOST_AUTO_TEST_CASE(parse_delta_1232) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;N:2212;proc:Weak[CC],RES;res:0");
  BOOST_TEST(evt.resonance_type.has_value());
  BOOST_TEST(evt.resonance_type.value() == P33_1232);
}

BOOST_AUTO_TEST_CASE(parse_n1535_s11) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;N:2112;proc:Weak[CC],RES;res:1");
  BOOST_TEST(evt.resonance_type.value() == S11_1535);
}

BOOST_AUTO_TEST_CASE(parse_n1520_d13) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;N:2212;proc:Weak[CC],RES;res:2");
  BOOST_TEST(evt.resonance_type.value() == D13_1520);
}

BOOST_AUTO_TEST_CASE(parse_roper_resonance) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;N:2112;proc:Weak[CC],RES;res:8");
  BOOST_TEST(evt.resonance_type.value() == P11_1440);
}

BOOST_AUTO_TEST_CASE(parse_delta_1950) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;N:2212;proc:Weak[CC],RES;res:15");
  BOOST_TEST(evt.resonance_type.value() == F37_1950);
}
...
BOOST_AUTO_TEST_CASE(parse_decay_mode_0) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;N:2212;proc:Weak[CC],RES;res:0;dec:0");
  BOOST_TEST(evt.decay_mode.has_value());
  BOOST_TEST(evt.decay_mode.value() == 0);
}

BOOST_AUTO_TEST_CASE(parse_decay_mode_1) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;N:2212;proc:Weak[CC],RES;res:0;dec:1");
  BOOST_TEST(evt.decay_mode.value() == 1);
}

BOOST_AUTO_TEST_CASE(parse_decay_mode_2) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;N:2212;proc:Weak[CC],RES;res:0;dec:2");
...
BOOST_AUTO_TEST_CASE(parse_final_quark) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;N:2112;q:1(v);proc:Weak[CC],DIS;finalquark:2");
...
BOOST_AUTO_TEST_CASE(parse_final_lepton_muon) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;N:2112;proc:Weak[CC],QES;finallepton:13");
...
BOOST_AUTO_TEST_CASE(parse_final_lepton_electron) {
  auto evt = parse_evt_code("nu:12;tgt:1000180400;N:2112;proc:Weak[CC],QES;finallepton:11");
  BOOST_TEST(evt.final_lepton_pdg.value() == 11);
}

BOOST_AUTO_TEST_CASE(parse_final_lepton_tau) {
  auto evt = parse_evt_code("nu:16;tgt:1000180400;N:2112;proc:Weak[CC],QES;finallepton:15");
...
BOOST_AUTO_TEST_CASE(parse_hmult_protons) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;N:2112;proc:Weak[CC],DIS;hmult:(p=2,n=1)");
  BOOST_TEST(evt.hmult.n_protons == 2);
  BOOST_TEST(evt.hmult.n_neutrons == 1);
}

BOOST_AUTO_TEST_CASE(parse_hmult_pions) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;N:2112;proc:Weak[CC],DIS;hmult:(pi+=1,pi-=2,pi0=0)");
...
BOOST_AUTO_TEST_CASE(parse_hmult_full) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;N:2112;proc:Weak[CC],DIS;hmult:(p=1,n=2,pi+=1,pi-=0,pi0=1,gamma=2)");
...
BOOST_AUTO_TEST_CASE(parse_hmult_rho_mesons) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;N:2112;proc:Weak[CC],DIS;hmult:(rho+=1,rho-=0,rho0=1)");
...
BOOST_AUTO_TEST_CASE(full_ccres_event) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;N:2212;proc:Weak[CC],RES;res:0;dec:1;hmult:(p=1,pi+=1)");
  BOOST_TEST(evt.probe_pdg == 14);
  BOOST_TEST(evt.hit_nucleon_pdg.value() == 2212);
  BOOST_TEST(evt.scattering_type == ::caf::kRes);
  BOOST_TEST(evt.resonance_type.value() == P33_1232);
...
BOOST_AUTO_TEST_CASE(full_ccdis_charm_event) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;N:2112;q:3(s);proc:Weak[CC],DIS;charm:411;finalquark:4");
  BOOST_TEST(evt.probe_pdg == 14);
  BOOST_TEST(evt.hit_nucleon_pdg.value() == 2112);
  BOOST_TEST(evt.hit_quark_pdg.value() == 3);
  BOOST_TEST(evt.hit_sea_quark == true);
...
BOOST_AUTO_TEST_CASE(nccoh_event) {
  auto evt = parse_evt_code("nu:14;tgt:1000180400;proc:Weak[NC],COH");
  BOOST_TEST(evt.probe_pdg == 14);
  BOOST_TEST(evt.interaction_type == "Weak[NC]");
  BOOST_TEST(evt.scattering_type == ::caf::kCoh);
  BOOST_TEST(!evt.hit_nucleon_pdg.has_value());
...
BOOST_AUTO_TEST_CASE(antineutrino_ccqe_event) {
  auto evt = parse_evt_code("nu:-14;tgt:1000180400;N:2212;proc:Weak[CC],QES;finallepton:-13");
  BOOST_TEST(evt.probe_pdg == -14);
  BOOST_TEST(evt.hit_nucleon_pdg.value() == 2212);
  BOOST_TEST(evt.final_lepton_pdg.value() == -13);
}
...
BOOST_AUTO_TEST_CASE(tokens_in_different_order) {
  auto evt = parse_evt_code("proc:Weak[CC],QES;N:2112;tgt:1000180400;nu:14");
  BOOST_TEST(evt.probe_pdg == 14);
  BOOST_TEST(evt.target_pdg == 1000180400);
  BOOST_TEST(evt.hit_nucleon_pdg.value() == 2112);
  BOOST_TEST(evt.scattering_type == ::caf::kQE);
...
BOOST_AUTO_TEST_CASE(unknown_tokens_ignored) {
  auto evt = parse_evt_code("nu:14;unknown:value;tgt:1000180400;proc:Weak[CC],QES");
  BOOST_TEST(evt.probe_pdg == 14);
  BOOST_TEST(evt.target_pdg == 1000180400);
}
