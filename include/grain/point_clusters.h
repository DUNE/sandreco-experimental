  ...
  struct point_clusters : managed_data_base {
    class cluster : reco::hit {
      public:
        ...
        cluster() :
          reco::hit(pos_3d(0.0, 0.0, 0.0), dir_3d(0.0, 0.0, 0.0), reco::timerange(0.0, 0.0)) {}
        cluster(const pos_3d& c, const dir_3d& d, const reco::timerange& t, const std::vector<point_cloud::point>& points) : 
          reco::hit(c, d, t), m_clusterized_points(points) {}
